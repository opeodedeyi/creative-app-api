...
urlpatterns = [
    ...
    path("users/<slug:slug>/",
         UserRetriveAPIView.as_view(),
         name="users-detail"),
    # To get the authenticated user's own object, its provided by djago-rest-auth using this route: 'rest-auth/user'

    path("users/<slug:slug>/follow/",
         FollowAUserView.as_view(),
         name="users-follow"),

    path("users/<slug:slug>/unfollow/",
         UnFollowAUserView.as_view(),
         name="users-unfollow"),

    path("users/<slug:slug>/followers/",
         UserFollowerView.as_view(),
         name="user-followers"),
    ...
    path("profile/<int:pk>/skills/",
         ProfileSkillRUAPIView.as_view(),
         name="profile-skill-edit"),
